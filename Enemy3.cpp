...
Enemy3::Enemy3(sf::Texture * texture, sf::Vector2f playerPos)
{
	this->shootTimer = 50;
	...
	this->vx = (float)(rand() % 3)  + 1.0;
	this->vy = (float)(rand() % 3)  + 1.0;
	this->dx = rand() % 2;
	this->dy = rand() % 2;
	while (true)
	{
...
bool Enemy3::ifShoot(sf::Vector2f playerPos)
{
...
sf::Vector2f Enemy3::MoveEnemy(sf::Vector2f playerPos, sf::Vector2f mapSize)
{
